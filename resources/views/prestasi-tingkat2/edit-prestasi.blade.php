                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('update-prestasi2',$pres->id) }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <img src="{{ asset('imgPrestasi2/'.$pres->gambar) }}" height="10%" width="50%" alt="" srcset="">
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <input type="date" id="tgl" name="tgl" class="form-control" value="{{ $pres->tgl }}">
