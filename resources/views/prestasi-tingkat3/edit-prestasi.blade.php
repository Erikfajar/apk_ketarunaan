                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('update-prestasi3',$pres->id) }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <select name="tingkat" id="tingkat" class="form-control">
                                            <option value="XII">{{ $pres->tingkat }}</option>
                                        </select>
                                    </div>
                                    <br>
                                      <div class="form-group">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <img src="{{ asset('imgPrestasi3/'.$pres->gambar) }}" height="10%" width="50%" alt="" srcset="">
                                    </div>
                                    <br>
                                    <div class="form-group">
