        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    <form action="{{ route('data-melanggar2') }}" method="GET">
                        <li class="nav-item">
                    ...
                    {{-- <li class="nav-item">
                        <a href="{{ route('logout') }}" class="btn btn-primary d-sm-inline-block d-none">LOGOUT <i class="fa-solid fa-right-from-bracket fa-lg"></i></a>
                    </li> --}}
                </ul>
            </div>
        </nav>
