            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Create Data</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Create Taruna Yang Melakukan Pelanggaran</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('simpan-taruna2') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <input type="text" id="alasan" name="alasan" class="form-control" placeholder="Alasan Melanggar">
                                    </div>
                                    <br>
                                    <div class="form-group">
